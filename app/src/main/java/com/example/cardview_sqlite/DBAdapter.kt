...
class DBAdapter (private val listDataku : ArrayList<DBModel>) : RecyclerView.Adapter<DBAdapter.CardViewHolder>() {
    inner class CardViewHolder(itemV : View) : RecyclerView.ViewHolder(itemV) {
        ...
        var btndelete : TextView = itemV.findViewById(R.id.btn_deletecard)
        var btnupdate : TextView = itemV.findViewById(R.id.btn_updatecard)
    }
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        ...
        holder.btnupdate.setOnClickListener {
            val pindahUpAc = Intent(holder.itemView.context, UpdateActivity::class.java)
            val bundle = Bundle()
